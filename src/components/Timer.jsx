...
const Timer = () => {
  ...
  return (
    ...
    >
      <motion.div
        className={`text-5xl md:text-6xl lg:text-7xl font-bold mb-4 ${background === 'sky' ? 'text-black' : 'text-white'}`}
      ...
      <div className="space-x-4 mb-4 flex flex-col md:flex-row">
        <button
          onClick={() => setIsRunning(!isRunning)}
          className="mb-2 md:mb-0 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition duration-200"
        >
      ...
      <div className="space-x-4 flex flex-wrap justify-center">
        {Object.keys(backgrounds).map((bg) => (
          <button
            ...
            className={`px-4 py-2 m-1 rounded-lg transition duration-200 ${background === bg ? 'bg-gray-700 text-white' : 'bg-gray-300'}`}
          >
